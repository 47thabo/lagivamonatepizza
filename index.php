...
<?php include 'php/navbar.php';?>
    ...
    <section class="section1">
                ...
                <div class= "b-text">
                    <div>
                    <!--h1>Vision</h1-->
                    <p>Good things come to those who chase, as we say hands to hands, the smarter you eat, one bite puts your heart, soul, mind, into your smallest units that will be your secret of success.</p>
                    </div>
                </div>
            </section>
    ...
    <div class="white-cont">
        ...
        <div class="col-lg-4 text-center h-menu-heading bg-light my-3" style="margin:auto;border-top: 2px groove black;border-bottom: 2px groove black;">     
